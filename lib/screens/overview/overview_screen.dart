            ...
            builder: (context, state) {
              if (state is OverviewInitial) {
                context.read<OverviewBloc>().add(
                    LoadDataEvent()); // init state happens upon start but timer could have been started already, this this value has to be checked beforehand (maybe stored in shared prefs)
              }
